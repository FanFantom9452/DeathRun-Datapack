#Made By Fan_Fan_tom
#清除成就
advancement revoke @s only system:dash_right

#清除
clear @s paper[custom_data~{dash_right:1b}]
...
#設置冷卻
scoreboard players set #20 dash_right.cd 20
scoreboard players operation @s dash_right.cd = all_player_cd dash_right.cd
scoreboard players operation @s dash_right.cd *= #20 dash_right.cd
#禁止同時使用
