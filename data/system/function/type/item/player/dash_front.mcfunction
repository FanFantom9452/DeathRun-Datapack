...
execute if score @s dash_front.cd matches 1.. run scoreboard players operation tmp dash_front.cd = @s dash_front.cd
execute if score @s dash_front.cd matches 1.. run scoreboard players set #20 dash_front.cd 20
execute if score @s dash_front.cd matches 1.. run scoreboard players operation tmp dash_front.cd /= #20 dash_front.cd
execute if score @s dash_front.cd matches 1.. run item replace entity @s hotbar.4 with paper[item_model="minecraft:barrier",item_name=[{"color":"red","italic":false,"text":"冷卻中"}]] 1
execute if score @s dash_front.cd matches 1.. run item modify entity @s hotbar.4 system:player/dash_front