#Made By Fan_Fan_tom
item replace entity @s hotbar.3 with paper[item_model="minecraft:red_wool",item_name=[{"color":"red","italic":false,"text":"冷卻中"}]] 1
item replace entity @s hotbar.4 with paper[item_model="minecraft:red_wool",item_name=[{"color":"red","italic":false,"text":"冷卻中"}]] 1
item replace entity @s hotbar.5 with paper[item_model="minecraft:red_wool",item_name=[{"color":"red","italic":false,"text":"冷卻中"}]] 1
#頭顱
