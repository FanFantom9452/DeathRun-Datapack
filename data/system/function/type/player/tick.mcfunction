...
#死神運作
execute if entity @s[team=death_god,gamemode=adventure] run function system:type/player/death_god/tick
#逃亡者運作 | 碰到水死亡 | 抵達終點
execute if entity @s[team=runner,gamemode=adventure] run function system:type/player/runner/tick